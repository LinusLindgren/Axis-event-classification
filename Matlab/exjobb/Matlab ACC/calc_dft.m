...
% 
% 
% P2 = abs(dft_samples(:,1,random_pos_file)/nbrOfSamples);
% P1 = P2(1:nbrOfSamples/2+1);
% P1(2:end-1) = 2*P1(2:end-1);
% f = 200*(0:(nbrOfSamples/2))/nbrOfSamples;
% plot(f,P1, 'g')
% title('Single-Sided Amplitude Spectrum of X(t)')
% xlabel('f (Hz)')
% ylabel('|P1(f)|')
% hold on;
% P2 = abs(dft_samples(:,1,random_neg_file)/nbrOfSamples);
% P1 = P2(1:nbrOfSamples/2+1);
% P1(2:end-1) = 2*P1(2:end-1);
% f = 200*(0:(nbrOfSamples/2))/nbrOfSamples;
% plot(f,P1, 'r')
...
% 
% figure;
% P2 = abs(dft_samples(:,2,random_pos_file)/nbrOfSamples);
% P1 = P2(1:nbrOfSamples/2+1);
% P1(2:end-1) = 2*P1(2:end-1);
% f = 200*(0:(nbrOfSamples/2))/nbrOfSamples;
% plot(f,P1, 'g')
...
% ylabel('|P1(f)|')
% hold on;
% P2 = abs(dft_samples(:,2,random_neg_file)/nbrOfSamples);
% P1 = P2(1:nbrOfSamples/2+1);
% P1(2:end-1) = 2*P1(2:end-1);
% f = 200*(0:(nbrOfSamples/2))/nbrOfSamples;
% plot(f,P1, 'r')
...
% figure;
% 
% P2 = abs(dft_samples(:,3,random_pos_file)/nbrOfSamples);
% P1 = P2(1:nbrOfSamples/2+1);
% P1(2:end-1) = 2*P1(2:end-1);
% f = 200*(0:(nbrOfSamples/2))/nbrOfSamples;
% plot(f,P1, 'g')
...
% ylabel('|P1(f)|')
% hold on;
% P2 = abs(dft_samples(:,3,random_neg_file)/nbrOfSamples);
% P1 = P2(1:nbrOfSamples/2+1);
% P1(2:end-1) = 2*P1(2:end-1);
% f = 200*(0:(nbrOfSamples/2))/nbrOfSamples;
% plot(f,P1, 'r')
