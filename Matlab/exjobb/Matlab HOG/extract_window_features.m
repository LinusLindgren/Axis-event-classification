function [ features ] = extract_window_features( cell_histos, cell_y_index,cell_x_index )
...
for i=1:15
    ...
    for j=1:7
        conc_hist_vec(1:9) = cell_histos(cell_y_index+i-1,1:9,cell_x_index+j-1); 
        conc_hist_vec(10:18) = cell_histos(cell_y_index + i+1-1,1:9,cell_x_index +j -1);
        conc_hist_vec(19:27) = cell_histos(cell_y_index +i - 1,1:9,cell_x_index + j+1 -1);
        conc_hist_vec(28:36) = cell_histos(cell_y_index + i+1-1,1:9,cell_x_index +j+1-1);
